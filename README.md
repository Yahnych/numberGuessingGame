...
```
If you understand how all this works, [Take a look at the next version, which includes a random number generator](https://github.com/kittykatattack/randomNumberGame).
